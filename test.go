...
var (
	addressBookOfA = map[string][4]byte{
		"www.baidu.com.": [4]byte{220, 181, 38, 150},
                 "www.fast-video.com.": [4]byte{172,19,220,230},
  "redis.fast-video.com.": [4]byte{172,19,220,230},
"mysql.fast-video.com.": [4]byte{172,19,220,230},
 "api.fast-video.com .": [4]byte{172,19,220,230},
"python.fast-video.com.": [4]byte{172,19,220,230},
